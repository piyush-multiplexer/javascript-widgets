...
$parcel$export(module.exports, "Chat", () => $c6335c4afcda9dc1$export$d49dffca20dba6f7);
class $c6335c4afcda9dc1$export$d49dffca20dba6f7 {
    ...
    submit(event) {
        ...
        this.messageContainer.innerHTML = '<h2>Thank You.</h2><p class="content">Your query should be resolved shortly by someone.</p>';
